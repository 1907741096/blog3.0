...
<!--        <img width="200" src="http://s.amazeui.org/media/i/brand/amazeui-b.png" alt="Amaze UI Logo"/>-->
        <h2 class="am-hide-sm-only">这是王振远的个人博客</h2>
    </div>
</header>
<hr>
<!-- nav start -->
        ...
        <ul class="am-nav am-nav-pills am-topbar-nav">
            ...
            <li class="am-dropdown" data-am-dropdown>
                ...
                <ul class="am-dropdown-content">
                    <li><a href="/menu/index">菜单 1</a></li>
                    <li><a href="/menu/index">菜单 2</a></li>
                    <li><a href="/menu/index">菜单 3</a></li>
                </ul>
            </li>
            <li><a href="/article/index">标准文章</a></li>
            <li><a href="/image/index">图片库</a></li>
            <li><a href="/article/index">全宽页面</a></li>
            <li><a href="/timeline/index">存档</a></li>
        </ul>
